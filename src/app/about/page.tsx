...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "lubaina.h2024@vitstudent.ac.in",
    href: "mailto:lubaina.h2024@vitstudent.ac.in",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "Contact via email",
    href: "mailto:lubaina.h2024@vitstudent.ac.in",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "http://www.linkedin.com/in/lubaina-h-68a5b735a",
    content: "/lubaina-h-68a5b735a",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Lubaina-90909",
    content: "/Lubaina-90909",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10">
              ...
              working on robotics projects, or learning about the latest advancements in machine learning and automation.
            </p>
