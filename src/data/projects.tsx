...
const projects: Project[] = [
  ...
  { // 03. Portfolio project
    ...
    live: "/",
    github:"https://github.com/Lubaina-90909/3D-interactive-portfolio",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
  ...
  { // 05. Smart Job Tracker project
    ...
    title: "Smart Job Tracker - Advanced Job Application Management System",
    ...
    github:"https://github.com/AyushUpadhyay-EIC/Job-tracker-application",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            🚀 Transform your job search experience with Smart Job Tracker - a comprehensive, 
            feature-rich application designed to streamline and optimize your career journey. 
            This powerful tool combines modern web technologies with intuitive design to deliver 
            an unparalleled job application management experience.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="font-mono text-sm">
              <strong>📊 Visual Dashboard:</strong> Kanban-style board for intuitive job tracking
            </div>
            <div className="font-mono text-sm">
              <strong>🔍 Smart Filtering:</strong> Advanced search and filter capabilities
            </div>
            <div className="font-mono text-sm">
              <strong>📱 Responsive Design:</strong> Seamless experience across all devices
            </div>
            <div className="font-mono text-sm">
              <strong>🔔 Smart Notifications:</strong> Interview reminders and status updates
            </div>
            <div className="font-mono text-sm">
              <strong>📈 Analytics:</strong> Progress tracking and application insights
            </div>
            <div className="font-mono text-sm">
              <strong>🔐 Secure Storage:</strong> Firebase-powered data protection
            </div>
          </div>

          <TypographyH3 className="my-4 mt-8">🎨 User Experience Highlights</TypographyH3>
          <p className="font-mono mb-4">
            Experience a sleek, dark-themed interface that reduces eye strain during long job search 
            sessions. The application features smooth animations, intuitive navigation, and a 
            carefully crafted user journey that makes job tracking feel effortless and engaging.
          </p>

          <TypographyH3 className="my-4 mt-8">🛠️ Technical Excellence</TypographyH3>
          <p className="font-mono mb-4">
            Built with cutting-edge technologies including Next.js for optimal performance, 
            Tailwind CSS for responsive styling, and Firebase for real-time data synchronization. 
            The application demonstrates best practices in modern web development with clean code 
          ...
          <TypographyP className="font-mono text-center mt-6 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
            💻 Crafted with passion and precision by <strong>Ayush Upadhyay</strong> 🚀
          </TypographyP>
